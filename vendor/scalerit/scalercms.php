...
class ScalerITSDK {
    ...
    private function make_call($request, $data = false, $method = 'GET', $bypass = false) {
        ...
        if(($this->auth_token != false || $this->get_value('directus_refresh')) && $bypass == false)
    ...
    public function get_login_state() {
        ...
        if ($this->get_value('directus_access')!="") {
            return $this->users_me(array(
                'fields' => array(
                    '*','avatar.*','instances.*'
                )
            ));
    ...
    public function get_image_token() {
        if ($this->get_value('directus_access')!="") {
            return $this->get_value('directus_access');
        }
        else
